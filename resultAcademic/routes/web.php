...
Route::get('/awards', [AwardController::class, 'index'])
    ->middleware(['auth', 'verified', 'permission:view_all_results|view_department_results|view_own_results'])
    ->name('awards');

Route::post('/awards', [AwardController::class, 'store'])
    ->middleware(['auth', 'verified', 'permission:create_result'])
    ->name('awards.store');

Route::put('/awards/{id}', [AwardController::class, 'update'])
    ->middleware(['auth', 'verified', 'permission:edit_any_result|edit_department_result|edit_own_result'])
    ->name('awards.update');

Route::delete('/awards/{id}', [AwardController::class, 'destroy'])
    ->middleware(['auth', 'verified', 'permission:delete_any_result|delete_department_result|delete_own_result'])
    ->name('awards.destroy');
...
// Rutas de administración (encapsuladas en un único permiso: admin_system)
Route::middleware(['auth', 'verified', 'permission:admin_system'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::put('/roles/{id}', [App\Http\Controllers\AdminController::class, 'updateRole'])->name('roles.update');
    Route::delete('/roles/{id}', [App\Http\Controllers\AdminController::class, 'destroyRole'])->name('roles.destroy');
});
